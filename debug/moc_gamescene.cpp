...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->scoreChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->gameLoop(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameScene::*)(bool )>(_a, &GameScene::gameOver, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameScene::*)(int , int )>(_a, &GameScene::scoreChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void GameScene::gameOver(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void GameScene::scoreChanged(int _t1, int _t2)
{
